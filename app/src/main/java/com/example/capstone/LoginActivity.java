    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nologin.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {//비로그인 버튼 클릭하면
                ...
                Toast.makeText(context, "비회원 로그인", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
        ...
        @SuppressLint("HandlerLeak") OAuthLoginHandler naverLoginHandler = new OAuthLoginHandler() {
            ...
            public void run(boolean success) {
                if (success) {//로그인 성공
                    ...
                    Log.d("naverLoginHandler", "execute");
//                    finish();
...
//        }
    ...
    public class RequestApiTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {//작업이 실행되기 전에 먼저 실행.
            Log.d("RequestAPITask", "RequestAPITask");
        }
        ...
        public void onPostExecute(String content) {//doInBackground 에서 리턴된 값이 여기로 들어온다.
            try {
                ...
                Toast.makeText(context, "네이버 로그인", Toast.LENGTH_SHORT).show();
                startActivity(intent);
