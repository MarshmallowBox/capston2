...
//
//
//    void createNav_Drawer(final String Name, final String Email, final String Profile, final String Agerange) {
...
////                                        show2(Name, Email, Profile, Agerange);
//////                                        Intent intent = new Intent();
//////                                        intent.putExtra("logout_user", textView.getText().toString() + "님이 로그아웃 하셨습니다.");
//////                                        context.setResult(LoginActivity.LOG_OUsT_FLAG = 1, intent);
//////                                        context.finish();
////                                    }
////                                });
...
//        dialog.show();
//    }
//    void show2(final String Name, final String Email, final String Profile, final String Agerange) {
//        AlertDialog.Builder builder = new AlertDialog.Builder(context);
//        LayoutInflater inflater = context.getLayoutInflater();
//        View view = inflater.inflate(R.layout.user_data, null);
//        builder.setView(view);
//        TextView ni = view.findViewById(R.id.tvNickname);
//        ni.setText(Name);
//        TextView em = view.findViewById(R.id.tvEmail);
//        em.setText(Email);
//        TextView ag = view.findViewById(R.id.tvAgeRange);
//        ag.setText(Agerange);
//        ImageView ivProfile = view.findViewById(R.id.ivProfile);
//        Glide.with(context).load(Profile).into(ivProfile);
//
//        final AlertDialog dialog = builder.create();
////        submit.setOnClickListener(new View.OnClickListener() {
////            public void onClick(View v) {
